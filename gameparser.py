...
def remove_punct(text):
    ...
    'goSouTh'
    """
    normalise_punctuation = str("")
    for char in text:
        if not (char in string.punctuation):
            normalise_punctuation = normalise_punctuation + char
...
def normalise_input(user_input):
    ...
    """
    normalised_input = remove_punct(user_input)
    normalised_input = normalised_input.lower()
    suitable_words = filter_words(normalised_input.split(), skip_words)
